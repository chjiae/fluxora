...
record RelayEventPayload(String eventId, String eventType, String requestId, Instant occurredAt, long tenantId,
    ...
    static RelayEventPayload from(Map<String, String> fields) {
